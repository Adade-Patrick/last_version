<div class="ml-64 bg-gray-200">
    <div class="text-center text-2xl font-semibold p-4 bg-blue-500 text-white">
        {{ $cours->titre }}
    </div>
    @include('livewire.chapitre.modals.modal')

    <div class="flex justify-end p-2">
        {{-- creer un chapitre  --}}
        <button wire:click="toggleAddChapitreModal"  class=" text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-600 dark:focus:ring-blue-700" type="button">
            <div class="flex">
            ...
            @foreach ($cours->chapitres as $chapitre )
                <div>
                    <div class="relative overflow-x-auto mb-4  shadow-md sm:rounded-lg">
                        <table class=" w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <caption class="relative p-3 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-blue-200 dark:text-white dark:bg-gray-800">
                                ...
                                <div class="absolute top-4 right-4">
                                    <button  class="toggle-eyes bg-green-400   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 text-center" aria-controls="dropdown-example-{{ $chapitre->id }}" data-collapse-toggle="dropdown-example-{{  $chapitre->id }}" type="button">
                                        <div class="flex">
                                            <svg class="w-5 h-5  eye text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                            </svg>

                                            <svg xmlns="http://www.w3.org/2000/svg" class="text-white hidden w-5 h-5 no-eye" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
                                    ...
                                    <button  class="add-section  text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                        <div class="flex">
                            ...
                            <tbody id="dropdown-example-{{  $chapitre->id }}" class="hidden">
                        ...
                        <form class="form-section hidden flex-wrap items-center gap-4 p-4">
                            ...
                            <input type="text" name="description" placeholder="Description"
                                class="border border-gray-300 rounded-lg px-3 py-2 w-64 focus:outline-none focus:ring focus:border-blue-300" required>

                            <input type="file" name="videoUrl" placeholder="URL Vidéo"
                            ...
                            <input type="file" name="pdfUrl" placeholder="URL PDF"
                                class="border border-gray-300 rounded-lg px-3 py-2 w-64 focus:outline-none focus:ring focus:border-blue-300 bg-white" required>
