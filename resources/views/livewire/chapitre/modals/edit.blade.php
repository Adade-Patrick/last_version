    <!-- Main modal -->
<div class= "@if(!$editChapitreModal) invisible @else flex @endif overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black/40">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-blue-600 border-gray-200">
                ...
                <button wire:click="toggleEditChapitreModal"  type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
            ...
            <!-- Modal body -->
            <form wire:submit.prevent="editChapitre" class="p-4 md:p-5" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="checkbox" id="oui" wire:model="has_evaluation" @if($has_evaluation ) @checked(true) @endif class="accent-primary-600 focus:ring-primary-500">
                ...
                <button wire:click="toggleEditChapitreModal"  type="reset" class="text-white inline-flex items-center bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-500 dark:focus:ring-red-500">
                    Annuler
                </button>
            </form>
        </div>
