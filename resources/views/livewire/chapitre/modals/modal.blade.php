    <!-- Main modal -->
<div class= " @if(!$addChapitreModal) hidden @else flex @endif overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full bg-black/40">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form wire:submit.prevent="store" class="p-4 md:p-5" enctype="multipart/form-data">
