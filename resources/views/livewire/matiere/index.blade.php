        ...
        @endif
            <form wire:submit.prevent= @if($isModify) "update" @else "store" @endif  >
                ...
                <div class="flex ">
                    ...
                    <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-500">      @if($isModify) Modifier la matiere @else Créer la matière @endif </button>
                </div>
            </form>
        </div>
    </div>
