    ...
    <main class="mt-15 mb-15">
        <div class="p-6 bg-gray-100">
            ...
            <form>
                <!-- Titre du cours -->
                <div class="mb-4">
                    <label class="block text-sm font-medium text-blue-700 mb-1">Titre du cours</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-medium text-blue-700 mb-1">Classe</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-blue-700 mb-1">Matière</label>
                        <select class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                ...
                <!-- Description -->
                <div class="mb-4">
                    <label class="block text-sm font-medium text-blue-600 mb-1">Description du cours</label>
                ...
                <div class="mb-6">
                    ...
                    <button type="button" class="bg-blue-500 text-white px-4 py-1 rounded hover:bg-blue-600">
                        + Ajouter un module
                    </button>
                </div>
