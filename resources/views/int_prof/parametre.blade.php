                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        ...
                                        <div class="font-medium truncate">{{ Auth::user()->prof->infoPerso->nom }}</div>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        ...
                                        <div class="font-medium truncate">{{ Auth::user()->prof->infoPerso->prenom }}</div>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        ...
                                        <div class="font-medium truncate">{{ Auth::user()->prof->infoPerso->date_N }}</div>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        <div class="font-bold">Date de naissance</div>
                                        <div class="font-medium truncate">{{ Auth::user()->prof->infoPerso->lieu_N }}</div>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        ...
                                        <div class="font-medium truncate">{{ Auth::user()->prof->infoPerso->sexe }}</div>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        ...
                                        <div class="font-medium truncate">{{ Auth::user()->prof->infoPerso->nationalite }}</div>
                                    </label>
                                </div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                        ...
                                        <div class="font-medium truncate">{{ Auth::user()->prof->infoPerso->ville_residence }}</div>
                                    </label>
                                </div>
