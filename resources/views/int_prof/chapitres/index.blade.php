...
<div class="ml-64">
    <div class="text-center text-2xl font-semibold p-4 bg-blue-600 text-white">
        Getion des chapitres
    </div>


    <div class="flex justify-end p-2">
        {{-- creer un chapitre  --}}
        <button data-modal-target="create-chapitre-modal" data-modal-toggle="create-chapitre-modal"  class=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
            <div class="flex">
